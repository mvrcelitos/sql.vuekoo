...
>(({ className, ...props }, ref) => (
   <MenubarPrimitive.Trigger
      ref={ref}
      className={cn(
         "flex cursor-default select-none items-center rounded-md px-2 py-1 text-sm font-medium outline-none focus:bg-zinc-200 focus:text-foreground focus:text-zinc-900 data-[state=open]:bg-zinc-200 data-[state=open]:text-foreground dark:focus:bg-zinc-800 dark:focus:text-zinc-50 dark:data-[state=open]:bg-zinc-800 dark:data-[state=open]:text-foreground",
         className,
      )}
      {...props}
   />
...
>(({ className, children, checked, ...props }, ref) => (
   <MenubarPrimitive.CheckboxItem
      ref={ref}
      className={cn(
         "relative flex cursor-default select-none items-center rounded-sm py-1.5 pl-8 pr-2 text-sm outline-none focus:bg-zinc-200 focus:text-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50 dark:focus:bg-zinc-800",
         className,
      )}
      checked={checked}
      {...props}>
