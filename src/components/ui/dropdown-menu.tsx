...
export const dropdownMenuContentVariants = cva({
   base: "z-[100] min-w-[8rem] overflow-hidden rounded-lg border p-1 shadow-vercel-md data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2",
   variants: {
      intent: {
...
>(({ intent, className, children, ...props }, ref) => (
   <DropdownMenuPrimitive.SubTrigger
      ref={ref}
      className={cn(dropdownMenuItemsVariants({ intent }), "pr-1", className)}
      {...props}>
      {children}
