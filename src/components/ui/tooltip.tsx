...
>(({ className, sideOffset = 4, children, ...props }, ref) => (
   <TooltipPrimitive.TooltipPortal>
      <TooltipPrimitive.Content
         ...
         className={cn(
            "z-50 overflow-hidden rounded-md bg-zinc-950 px-3 py-1.5 text-xs text-zinc-200 animate-in fade-in-0 zoom-in-95 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 dark:bg-zinc-50 dark:text-zinc-700",
            className,
         )}
         {...props}>
         {children}
