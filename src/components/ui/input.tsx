...
export const inputVariants = cva({
   ...
   variants: {
      intent: {
         none: "",
         primary:
            "border border-zinc-300 dark:border-zinc-700 dark:text-zinc-200 ring-0 focus:ring-1 focus:border-primary ring-primary dark:focus:border-primary dark:focus:ring-primary",
         primary2:
